...
#  uses.
#c.NotebookApp.tornado_settings = {"headers":{"Content-Security-Policy": "frame-ancestors * self host_ip:port"}}
...
c.ServerProxy.servers = {
  'tutorial': {
    'command': ['pserve', '/etc/tutorial-server/production.ini', 'port={port}', 'base_url={base_url}', 'app_prefix=/tutorial'],
    'absolute_url': True,
    'timeout': 30
  }
}
